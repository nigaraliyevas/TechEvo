            ...
            <ul className={styles.navbar_pages}>
              <li className={styles.navbar_links}>
                ...
                <div className={styles.link_catagiries}>
                  <div>
                    <ul>
                      <li> <span>•</span> Oyun üçün</li>
                      <li> <span>•</span> Dizayn üçün</li>
                      <li> <span>•</span> Ofis üçün</li>
                      <li> <span>•</span> Ev üçün</li>
                      <li> <span>•</span> Hamısı</li>
                    </ul>
                  </div>
                </div>
              </li>
              <li className={styles.navbar_links}>Laptop</li>
              <li className={styles.navbar_links}>Aksesuarlar
              <div className={styles.link_catagiries}>
                  <div>
                    <ul>
                      <li> <span>•</span> Oyun üçün</li>
