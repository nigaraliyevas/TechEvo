  ...
  return (
    <div className={style.redy_product_container}>
      <div className={style.redy_product_left}>
        <div className={style.redy_product_title}>Nə üçün istifadə edəcəksən?</div>
        <div>
          <select value={usingPurpose} onChange={e => setUsingPurpose(e.target.value)}>
            <option value="">Seçin</option>
            <option value="Gaming, Professional Work">Oyunlar</option>
            <option value="Content Creation">Dizayn işləri</option>
            ...
            <option value="Workstation">Evdə yüngül istifadə</option>
            <option value="Recording">Video və şəkil redaktəsi</option>
          </select>
        </div>
        <div className={style.redy_product_title}>Harada istifadə edəcəksən?</div>
        <div>
          <select value={whereUse} onChange={e => setWhereUse(e.target.value)}>
            <option value="">Seçin</option>
            <option value="Home, Office">Evdə</option>
            <option value="Office, Home">Evdən kənarda</option>
          </select>
        </div>
        <div className={style.redy_product_title}>Görünüşü necə olsa daha yaxşıdı?</div>
        <div>
        ...
        {produc ? (
          <div>
            ...
            <div className={style.redy_product_right_bottom}>
              <Link style={{ display: "inline-block" }} to={`/product?id=${produc.id}`} className={style.redy_product_right_btn_more}>
                Ətraflı bax
