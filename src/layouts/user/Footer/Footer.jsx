      ...
      <div className={style.container}>
        <div className={style.footer_top}>
          ...
          <div className={style.footer_icons}>
            <Link to="https://www.instagram.com/techevo.az/" className={style.footer_icon}>
              <FaInstagram size={24} />
            </Link>
            <Link to="https://twitter.com/TECHEVOservices" className={style.footer_icon}>
              <FaTwitter size={24} />
            </Link>
            <Link to="https://www.facebook.com/techevostore/" className={style.footer_icon}>
              <FaFacebook size={24} />
            </Link>
          </div>
        </div>
