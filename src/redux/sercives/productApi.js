...
export const productApi = createApi({
  ...
  endpoints: builder => ({
    ...
    getSpecifications: builder.query({
      query: categoryName => `product/specification/filterByCategoryName?categoryName=${categoryName}`,
    }),
    getFilterValues: builder.query({
      query: categoryName => `product/category/getFilters?categoryName=${categoryName}`,
    }),
...
export const {
  ...
  useGetAllProductsQuery, // Yeni hook
} = productApi;
