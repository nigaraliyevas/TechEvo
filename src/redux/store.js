...
const store = configureStore({
  ...
  middleware: getDefaultMiddleware => getDefaultMiddleware().concat(productApi.middleware).concat(reviewsApi.middleware).concat(favoriteApi.middleware).concat(userApi.middleware), // commentApi middleware-i əlavə et
